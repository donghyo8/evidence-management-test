...
echo "========== POST request_Org1 등록  ... =========="
echo
ORG1_TOKEN=$(curl -s -X POST \
  http://localhost:4000/users \
  -H "content-type: application/x-www-form-urlencoded" \
  -d 'username=testor1&orgName=Org1')
echo $ORG1_TOKEN
...
echo "========== POST request_Org2 등록 ... =========="
echo
ORG2_TOKEN=$(curl -s -X POST \
  http://localhost:4000/users \
  -H "content-type: application/x-www-form-urlencoded" \
  -d 'username=testor2&orgName=Org2')
echo $ORG2_TOKEN
...
echo "========== POST request_Org3 등록 ... =========="
echo
ORG3_TOKEN=$(curl -s -X POST \
  http://localhost:4000/users \
  -H "content-type: application/x-www-form-urlencoded" \
  -d 'username=testor3&orgName=Org3')
echo $ORG3_TOKEN
...
echo "========== POST request_Org4 등록 ... =========="
echo
ORG4_TOKEN=$(curl -s -X POST \
  http://localhost:4000/users \
  -H "content-type: application/x-www-form-urlencoded" \
  -d 'username=testor4&orgName=Org4')
echo $ORG4_TOKEN
